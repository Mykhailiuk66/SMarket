...
class UserItem(models.Model):
    ...
    float = models.DecimalField(max_digits=18, ecimal_places=17, blank=True, null=True)
...
class Trade(models.Model):
    ...
    second_party = models.ForeignKey(Profile, on_delete=models.SET_NULL, null=True)
    quarantor = models.ForeignKey(Profile, on_delete=models.SET_NULL, null=True)
